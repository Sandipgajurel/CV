...
const Contact = () => {
  return (
    ...
    >
      <div className="column" style={{ flex: "50%", marginTop: "190px" }}>
        ...
        <div class="column" display="flex">
          <div class="row">
            ...
            <article>
              ...
              <span style={{ color: "white" }}>Sandipgajurel809@gmail.com</span>
              <a href="mailto:sandipgajulre9191@gmail.com">Send Mail</a>
            </article>
          </div>
          <hr />
