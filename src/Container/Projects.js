...
const Projects = () => {
  ...
  >
    <div className="column" style={{flex:'50%', marginTop:'250px'}}>
    <h1 style={{ color: 'ButtonShadow' }}>PROJECTS</h1><TaskAltIcon style={{color:'white'}} />
    </div>
    ...
    >
      <CardActionArea style={{ alignItems: "center" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <h3 style={{ color: "black" }}>
          <a href="https://github.com/Sandipgajurel/java-2nd_project.git">github link of this project</a> </h3>
        </div>
      </CardActionArea>
    </Card>
