      ...
      <div className="App" style={{ backgroundColor: "#cfd1d0" }}>
        ...
        <div>
          ...
          <Box
            style={{
              ...
              background: `linear-gradient(90deg, rgba(124,122,122,1) 0%, rgba(118,118,120,1) 0%)`,
              marginRight: "10px",
          ...
          <div className="column" style={{ flex: "50%", marginRight: "10px"}}>
            ...
            >
              <CardActionArea style={{ alignItems: "center" }}>
                <img style={{ width: "400px" }} src={reactimg} alt="" />
        ...
        >
         ...
         <h4 style={{color:'white'}}> Secondary Level</h4>
          ...
          <div className="column" style={{ flex: "50%", marginTop: "180px" }}>
        ...
        >
          ...
          <div className="column" style={{ flex: "50%", marginTop: "140px" }}>
